...
Автоматический scheduler и Telegram notifications добавляются следующим изменением. До этого очередь остаётся выключенной и не выполняет бизнес-действия.
