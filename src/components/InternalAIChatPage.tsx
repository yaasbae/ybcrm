...
export default function InternalAIChatPage() {
  ...
  return <div className="mx-auto flex min-h-[calc(100vh-150px)] max-w-4xl flex-col px-4 py-6 sm:px-6">
    ...
    <div className="mb-3 flex items-center gap-2 rounded-xl border border-emerald-200 bg-emerald-50 px-4 py-3 text-xs text-emerald-800"><ShieldCheck size={17} className="shrink-0"/><span><b>OpenAI GPT · безопасный режим:</b> чат только читает данные и не может менять CRM, отправлять сообщения или проводить платежи.</span></div>
